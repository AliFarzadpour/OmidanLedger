...
async function runSeeder() {
    ...
    const checkingAccountId = (0, uuid_1.v4)();
    const creditCardAccountId = (0, uuid_1.v4)();
    ...
    const sfhId = (0, uuid_1.v4)();
    const mfhId = (0, uuid_1.v4)();
    // Single Family Home
    ...
    // Units for MFH
    const unit1Id = (0, uuid_1.v4)();
    const unit2Id = (0, uuid_1.v4)();
    const unit3Id = (0, uuid_1.v4)();
    ...
    const createTx = (bankAccountId, description, amount, date, costCenter, category) => {
    ...
    const workOrderId1 = (0, uuid_1.v4)();
    const workOrderId2 = (0, uuid_1.v4)();
    const threadId1 = (0, uuid_1.v4)();
    const taskId1 = (0, uuid_1.v4)();
    ...
    const messageId1 = (0, uuid_1.v4)();
    const messageId2 = (0, uuid_1.v4)();
