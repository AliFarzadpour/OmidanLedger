...
function AcceptInvite() {
  ...
  const onSubmit = async (data: SignupFormValues) => {
    ...
    try {
      ...
      // At this point, Firebase automatically signs the user in.
      // onAuthStateChanged will trigger, and we can proceed.
      // We now call the server action to finalize linking.
