...
import { Loader2, Sparkles, BrainCircuit, AlertCircle, FilePlus, ListTree, PlusCircle, Trash2, Search, RefreshCw, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <Alert variant="destructive" className="bg-amber-50 border-amber-200 text-amber-800">
        ...
        <AlertDescription>
          The articles and answers provided here are generated by an AI assistant. While we strive for accuracy, please verify any critical financial or legal information with a qualified professional.
        </AlertDescription>
      </Alert>
