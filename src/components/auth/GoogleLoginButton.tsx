  ...
  return (
    ...
    >
      {isLoading ? (
        ...
        <Image
            src="https://firebasestorage.googleapis.com/v0/b/studio-7576922301-bac28.firebasestorage.app/o/logos%2Fgoogle.svg?alt=media&token=11739c63-7111-474c-8f43-097985e1654a"
            alt="Google icon"
            width={16}
            height={16}
            className="mr-2"
